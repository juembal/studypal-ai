                              ...
                              <div className="flex-1">
                                <div className="flex items-center gap-2 mb-1">
                                  ...
                                  <span className={`font-medium ${isCompleted ? 'line-through text-gray-500' : ''}`}>
                                    {subject.subject || subject.name || subject.title || 'Study Session'}
                                    {/* Debug: Show available properties */}
                                    <span className="text-xs text-red-500 ml-2">
                                      [Props: {Object.keys(subject).join(', ')}]
                                    </span>
                                  </span>
                                  <Badge 
                                ...
                                <p className={`text-sm ${isCompleted ? 'text-gray-400 line-through' : 'text-gray-600'}`}>
                                  {subject.focus || subject.topic || subject.description || 'Study focus'}
                                </p>
                              </div>
                            </div>
                            ...
                            <div className="text-right">
                              <div className="flex items-center gap-1 text-sm text-gray-500 mb-1">
                                ...
                                <span className={isCompleted ? 'line-through' : ''}>
                                  {subject.timeSlot || subject.time || 'Time TBD'}
                                </span>
                              </div>
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-3 flex-1">
                                  ...
                                  <div className="flex-1">
                                    <div className="flex items-center gap-2 mb-1">
                                      <BookOpen className="h-4 w-4" />
                                      <span className={`font-medium ${isCompleted ? 'line-through text-gray-500' : ''}`}>
                                        {session.subject || session.name || 'Study Session'}
                                      </span>
                                      <Badge 
                                ...
                                <div className="text-right">
                                  <div className="flex items-center gap-1 text-sm text-gray-500 mb-1">
                                    <Clock className="h-3 w-3" />
                                    <span className={isCompleted ? 'line-through' : ''}>
                                      {session.timeSlot || session.time || 'Time TBD'}
                                    </span>
                                  </div>
                                  <div className={`text-sm font-medium ${isCompleted ? 'line-through text-gray-400' : 'text-blue-600'}`}>
